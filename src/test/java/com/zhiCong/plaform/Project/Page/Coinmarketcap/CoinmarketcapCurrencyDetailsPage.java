...
public class CoinmarketcapCurrencyDetailsPage {
    ...
    @FindBy(xpath = "//button[@class = 'sc-f70bb44c-0 iQEJet BaseButton_base__aMbeB BaseButton_t-default__fZuC3 BaseButton_size-sm__RoliW BaseButton_v-tertiary___qgax BaseButton_vd__2Cn0v BaseButton_only-icon___aRCM']")
